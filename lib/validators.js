...
/* 
  Another possible implementation that has an Array as the chainable
  object.
*/

// function setMsgArr(m){
//   this[this.length-1].theMsg = m;
//   return this;
// }

// function convertArr(fn, name){
//   this[name] = function(){
...
_(_.omit(validator, nonValidators)).forEach(convertObj, exports);